...
<div class="panel panel-default" style="min-height: 100vh; background: #1d1f1ec4">
    <div class="panel panel-body" style="margin-top: 50px; background: #4b4d4c">
        <form class="navbar-form" role="search">
        <div class="col-md-4">

            <div class="pull-right">
                <select class="form-control" name="subject" id="dropdownMenu1" tabindex="1" style=" background: #4b4d4c; color: #fff;">
        ...
        <div class="col-md-8">
                ...
                <div class="form-group col-md-10">
                    <input style=" background: #4b4d4c; color: #fff;" type="text" class="form-control search-box" autocomplete="off" id="search-box" placeholder="Search">
                </div>
