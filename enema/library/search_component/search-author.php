        ...
        <form class="navbar-form" role="search">
                    ...
                    <select style=" background: #4b4d4c; color: #fff" class="form-control" name="subject" id="dropdownMenu1" tabindex="1">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($data = mysqli_fetch_assoc($result)) {
                                echo '<option value="'. $data['author'] .'">' . $data['author'] . '</option>';
                            }
                        }
                        ?>
                    </select>
            ...
            <div class="col-md-8">
                ...
                <div class="form-group col-md-10">
                    <input style=" background: #4b4d4c; color: #fff;" type="text" autocomplete="off" class="form-control search-box" id="search-box" placeholder="Search">
                </div>
...
<script src="js/search-author.js" type="text/javascript"></script>
</body>
</html>